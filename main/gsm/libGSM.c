...
#define CONFIG_GSM_APN 10



// === GSM configuration that you can set via 'make menuconfig'. ===
#define UART_GPIO_TX 27
#define UART_GPIO_RX 26
...
static const char * CONFIG_GSM_SMS_NUMBER = "05423872808";
#define EXAMPLE_TASK_PAUSE 30
#define CONFIG_GSM_SMS_INTERVAL 20
