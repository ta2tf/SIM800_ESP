...
#define SAMPLE_DEVICE_NAME          "SYA_TA2YF_TEST"
...
static uint8_t raw_adv_data[] = {
        ...
        0x03, 0x03, 0xFF, 0x00,
        /* device name */
        0x0f, 0x09, 'S', 'Y', 'A', '_', 'D', 'E', 'V', 'I', 'C', 'E', '_','V', '0', '1'
};
...
/* Service */
static const uint16_t GATTS_SERVICE_UUID_TEST      = ESP_GATT_UUID_BATTERY_SERVICE_SVC;
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    /* AAAAA Characteristic Declaration */
    [IDX_CHAR_A]     =
    ...
    /* BBBB Characteristic Declaration */
    [IDX_CHAR_B]      =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ,
    ...
    /*CCC Characteristic Declaration */
    [IDX_CHAR_C]      =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ,
...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    switch (event) {
        ...
        case ESP_GATTS_READ_EVT:
            ...
            ESP_LOGI(GATTS_TABLE_TAG, "GATT_READ_EVT, conn_id %d, trans_id %" PRIu32 ", handle %d\n", param->read.conn_id, param->read.trans_id, param->read.handle);
          			 ...
          			 if (BatVoltage != BatVoltage_old)
          			  {
							...
							BatValue[3] = (BatVoltage >>  0) & 0xFF;
          				    ...
          				    ESP_LOGI(GATTS_TABLE_TAG, "Notify Battery voltage : %X", BatVoltage);
          					for (int i = 0; i < 4; ++i)
          					{
          						notify_data[i] = BatValue[i];
          					}
